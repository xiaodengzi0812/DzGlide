...
import com.dengzi.dzglide.transformations.BlurTransformation;
import com.dengzi.dzglide.transformations.ColorFilterTransformation;
import com.dengzi.dzglide.transformations.CropCircleTransformation;
import com.dengzi.dzglide.transformations.CropSquareTransformation;
import com.dengzi.dzglide.transformations.CropTransformation;
import com.dengzi.dzglide.transformations.GrayscaleTransformation;
import com.dengzi.dzglide.transformations.MaskTransformation;
import com.dengzi.dzglide.transformations.RoundedCornersTransformation;
import com.dengzi.dzglide.transformations.gpu.BrightnessFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.ContrastFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.InvertFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.KuwaharaFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.PixelationFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.SepiaFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.SketchFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.SwirlFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.ToonFilterTransformation;
import com.dengzi.dzglide.transformations.gpu.VignetteFilterTransformation;
...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public MyAdapter(Context context, List<Type> dataSet) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        switch (dataSet.get(position)) {
            ...
            case CropBottom:
                Glide.with(context)
                        .load(R.drawable.demo)
                        .apply(bitmapTransform(new CropTransformation(Utils.dip2px(context, 300), Utils.dip2px(context, 100),
